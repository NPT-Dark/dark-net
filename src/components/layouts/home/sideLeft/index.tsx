...
export default function SideLeft(): React.ReactNode {
  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col items-start min-w-[350px] max-w-[350px] w-full gap-3 fixed left-[max(0px,calc((100vw-1920px)/2)+50px)] max-md:left-[max(0px,calc((100vw-1920px)/2)+25px)]">
