...
export default function About(): React.ReactNode {
  return (
    <section
      id="about"
      className="h-screen flex flex-col items-center gap-5 justify-center w-full snap-start max-h-[1080px]"
    >
      <h2 className="text-nowrap text-5xl">About Us</h2>
      <motion.p
        initial={{ opacity: 0, scale: 0 }}
        whileInView={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.7 }}
        viewport={{ once: true, amount: 0.2 }}
        className="leading-relaxed max-w-1/2 text-center"
      >
      ...
      <label className="italic">Built by Dark team</label>
    </section>
  );
}
